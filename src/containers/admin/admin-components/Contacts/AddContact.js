...
class AddContact extends Component {
  ...
  // Get the json object that will be displayed in the dropdown.
  componentWillMount() {
    axios
  ...
  render() {
    return <section className="container">
        ...
        <form autoComplete="off" onSubmit={e => this.handleSubmit(e)}>
          ...
          <input autoComplete="new-password" className="form-control" type="text" name='person_id' value={this.state.personInput} onClick={e => this.setState({ renderPersons: true })} onBlur={e => {
